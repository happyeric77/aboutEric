...
const Hero = (props) => {
    ...
    return(
        <div className='jumbotron container-fluid' style={{"background-image": `url(${pageInfo.jumbotron !== null ? pageInfo.domain + pageInfo.jumbotron.meta.download_url: "https://res.cloudinary.com/dydozrxhz/image/upload/v1591863195/media/images/jumbo-blue_jrgket.max-800x600_flrwnw.jpg"})`}}>
