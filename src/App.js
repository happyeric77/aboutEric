...
function App() {
    ...
    useEffect(()=>{
        axios.get('http://127.0.0.1:8000/api/v2/pages/4/')
            .then(res=>{
    ...
    return (
        <div className='jumbotron p-0 m-0 text-white' style={{"background-image": `url(${pageInfo.background !== null ? pageInfo.domain + pageInfo.background.meta.download_url: ""})`, "background-repeat": "no-repeat", "background-position": "center", "background-size": "cover"}}>
